...
function DigitalFashion() {
    return (<>
        <div id="df-intro" class="d-flex justify-content-start align-items-center">
            <div class="col-12 col-md-5">
                <AnimatedOnScroll animationIn="fadeInDownBig">
                    <p class="title">A New Way to Experience Digital Fashion</p>
                </AnimatedOnScroll>
                <AnimatedOnScroll animationIn="fadeInUp">
                    <p class="desc">We are a technology and content provider for digital fashion with end-to-end solutions for designers, brands and metaverses</p>
                </AnimatedOnScroll>
            </div>
        </div>
        <div class="container">
            <section className="mt-5 mb-5 pt-5 pb-5 row align-items-center">
                <div class="col-12 col-md-6">
                    ...
                    <AnimatedOnScroll animationIn="fadeInUp" delay="500">
                        <p class="desc">Drive engagement with unique interactivity
                            Create dynamic fashion experiences in any setting of your choice. Allow consumers, sales partners or internal teams to view and engage with pop-up fashion shows, launches or events via their devices. Perfect for city backdrops, shopping malls, events and campaigns.
                        </p>
            ...
            <section className="mt-5 mb-5 pt-5 pb-5 row align-items-center">
                ...
                <div class="col-12 col-md-6 mt-3 mt-md-0">
                    <AnimatedOnScroll animationIn="pulse">
                        <h1>Metaverse Utility</h1></AnimatedOnScroll>
                    <AnimatedOnScroll animationIn="fadeInUp" delay="500">
                        <p class="desc">
